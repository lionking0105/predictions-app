          ...
          <div className="charts grid grid-cols-1 gap-5 mt-6 max-w-5xl mx-auto md:grid-cols-2">
            ...
            <div className=" dark-bg rounded  p-6">
              ...
              <p className="draw-bg rounded custom-gray italic p-3 text-center mx-auto mt-5 mb-5 text-sm md:mb-16">
                In order to clarify this data here for example -1.5 means that
                there will be a maximum of 1.5 goals in the game, i.e : 1 goal.
              </p>
              <DoughnutChart
          ...
          <div className="charts grid grid-cols-1 gap-5 mt-6 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              <div className=" dark-bg rounded  p-6">
                ...
                <p className="draw-bg rounded custom-gray italic p-3 text-center mx-auto mt-5 mb-5 text-sm md:mb-16">
                  GF equates to “goals for” and refers to the number of goals a
                  team has scored.
                </p>
                <PieChart
              ...
              <div className=" dark-bg rounded  p-6">
                ...
                <p className="draw-bg rounded custom-gray italic p-3 text-center mx-auto mt-5 mb-5 text-sm md:mb-16">
                  GA refers to “goals against” and is solely the number of goals
                  a team has allowed to be scored against them.
                </p>
                <PieChart

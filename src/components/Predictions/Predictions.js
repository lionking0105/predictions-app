...
const Predictions = ({ fixture: { date }, teams: { home, away } }) => {
  return (
    <div className="prediction flex items-center transparent cursor-pointer flex-col lg:flex-row  p-6 rounded-xl last:mb-0 hover:translate-y-1 transition-all duration-300">
      <div className=" flex flex-wrap justify-center items-center flex-col w-full md:flex-row md:w-1/5">
        <div className="prediction-time mb-5 md:mb-0">
      ...
      <div className="flex text-white flex-wrap gap-5 justify-center items-center mt-2 flex-col md:gap-3 md:flex-row md:w-3/5 md:mt-0">
